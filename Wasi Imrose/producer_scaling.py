...
TOPIC = "topic_2"   # new topic, 12 partitions
...
# rate       = 200   - same as burst for direct comparison
# burst_prob = 0.6   - same as burst for direct comparison
# num_msgs   = 1000  - same message count
...
def run_simulation(num_messages=1000, rate=200, burst_prob=0.6):
    ...
    print(f"Starting scaling experiment: {num_messages} msgs at {rate} msg/s")
    print(f"Topic: {TOPIC} | Partitions: 12")
    print(f"Burst probability: {burst_prob*100:.0f}%\n")
    ...
    for i in range(num_messages):
        ...
        message = {
            ...
            "timestamp": time.time(),
            "burst": burst,
            "mode": "scaling"    #  labels this run in CSV
        }
...
if __name__ == "__main__":
    print("Scaling experiment starting in 5 seconds...")
    print("Switch to your consumer terminal and start scaling_consumer.py now.\n")
    time.sleep(5)
    run_simulation()
