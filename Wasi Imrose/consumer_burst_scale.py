...
TOPIC = "topic_2"
OUTPUT_CSV = "burst_12p_metrics.csv"
...
def run_consumer():
    ...
    print("Waiting for producer. Start burst_12p_producer.py now.\n")
    ...
    try:
        ...
        consumer.close()
        print("Done. CSV saved to burst_12p_metrics.csv")
